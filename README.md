...
- Vous devez concevoir en UML et implémenter en Java le jeu de société Kingdomino, en respectant une **architecture core_mvc** et en proposant une **interface graphique en Swing**.
